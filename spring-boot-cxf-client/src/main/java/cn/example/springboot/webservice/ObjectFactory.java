 ...
 * generated in the cn.example.springboot.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetAuthorByName_QNAME = new QName("http://www.springboot.example.cn/webservice", "getAuthorByName");
    private final static QName _GetAuthorByNameResponse_QNAME = new QName("http://www.springboot.example.cn/webservice", "getAuthorByNameResponse");
    private final static QName _GetAuthorList_QNAME = new QName("http://www.springboot.example.cn/webservice", "getAuthorList");
    private final static QName _GetAuthorListResponse_QNAME = new QName("http://www.springboot.example.cn/webservice", "getAuthorListResponse");
    private final static QName _GetAuthorString_QNAME = new QName("http://www.springboot.example.cn/webservice", "getAuthorString");
    private final static QName _GetAuthorStringResponse_QNAME = new QName("http://www.springboot.example.cn/webservice", "getAuthorStringResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.example.springboot.webservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.springboot.example.cn/webservice", name = "getAuthorByName")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.springboot.example.cn/webservice", name = "getAuthorByNameResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.springboot.example.cn/webservice", name = "getAuthorList")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.springboot.example.cn/webservice", name = "getAuthorListResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.springboot.example.cn/webservice", name = "getAuthorString")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.springboot.example.cn/webservice", name = "getAuthorStringResponse")
