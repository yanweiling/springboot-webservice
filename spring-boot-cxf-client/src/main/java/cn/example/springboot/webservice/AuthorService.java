 ...
 * 2020-03-21T22:05:19.493+08:00
 * Generated source version: 3.2.5
 *
 */
@WebServiceClient(name = "authorService",
                  wsdlLocation = "classpath:wsdl/author.wsdl",
                  targetNamespace = "http://www.springboot.example.cn/webservice")
public class AuthorService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://www.springboot.example.cn/webservice", "authorService");
    public final static QName AuthorPortName = new QName("http://www.springboot.example.cn/webservice", "authorPortName");
    static {
